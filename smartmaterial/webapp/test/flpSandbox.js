		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "smartmaterial",
									"targetURL": "#smartmaterialsmartmaterial-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"smartmaterialsmartmaterial-display": {
								"semanticObject": "smartmaterialsmartmaterial",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=smartmaterial.smartmaterial",
									"url": sap.ui.require.toUrl("smartmaterial/smartmaterial")
								}
							}
						}
					}
